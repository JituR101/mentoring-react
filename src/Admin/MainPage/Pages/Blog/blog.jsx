                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-12 col-md-6 col-xl-4">
                      <div className="course-box blog grid-blog">
                        <div className="blog-image mb-0">
                          <a href="/admin/blog-details"><img className="img-fluid" src={BLOG_01} alt="Post Image" /></a>
                        </div>
                        <div className="course-content">
                          ...
                          <div className="row">
                            <div className="col">
                              <a href="/admin/edit-blog" className="text-success">
                    ...
                    <div className="col-12 col-md-6 col-xl-4">
                      <div className="course-box blog grid-blog">
                        <div className="blog-image mb-0">
                          <a href="/admin/blog-details"><img className="img-fluid" src={BLOG_02} alt="Post Image" /></a>
                        </div>
                        <div className="course-content">
                          <span className="date">April 09 2020</span>
                    ...
                    <div className="col-12 col-md-6 col-xl-4">
                      <div className="course-box blog grid-blog">
                        <div className="blog-image mb-0">
                          <a href="/admin/blog-details"><img className="img-fluid" src={BLOG_03} alt="Post Image" /></a>
                        </div>
                        <div className="course-content">
                          <span className="date">April 09 2020</span>
