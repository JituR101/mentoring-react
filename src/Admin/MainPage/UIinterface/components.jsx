...
import {  AVATAR_12,AVATAR_13,AVATAR_14, IMG_01 } from "../../imagepath"
          ...
          <div className="comp-sec-wrapper">
              ...
              <div className="row">
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar avatar-xxl">
                        <img className="avatar-img rounded-circle" alt="User Image" src={AVATAR_12} />
                      </div>
                ...
                <div className="col-md-12">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar">
                        <img className="avatar-img rounded" alt="User Image" src={AVATAR_12} />
                      </div>
                      <div className="avatar">
                        <img className="avatar-img rounded-circle" alt="User Image" src={AVATAR_12} />
                      </div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar-group">
                        ...
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={AVATAR_13} />
                        </div>
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={AVATAR_14} />
                        </div>
                        <div className="avatar">
            ...
            <section className="comp-section comp-buttons">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <button type="button" className="btn btn-rounded btn-primary mr-1">Primary</button>
                  <button type="button" className="btn btn-rounded btn-secondary mr-1">Secondary</button>
                  <button type="button" className="btn btn-rounded btn-success mr-1">Success</button>
                  <button type="button" className="btn btn-rounded btn-danger mr-1">Danger</button>
                  <button type="button" className="btn btn-rounded btn-warning mr-1">Warning</button>
                  <button type="button" className="btn btn-rounded btn-info mr-1">Info</button>
                  <button type="button" className="btn btn-rounded btn-light mr-1">Light</button>
                  ...
                  <button type="button" className="btn btn-rounded btn-outline-primary mr-1">Primary</button>
                  <button type="button" className="btn btn-rounded btn-outline-secondary mr-1">Secondary</button>
                  <button type="button" className="btn btn-rounded btn-outline-success mr-1">Success</button>
                  <button type="button" className="btn btn-rounded btn-outline-danger mr-1">Danger</button>
                  <button type="button" className="btn btn-rounded btn-outline-warning mr-1">Warning</button>
                  <button type="button" className="btn btn-rounded btn-outline-info mr-1">Info</button>
                  <button type="button" className="btn btn-rounded btn-outline-light mr-1">Light</button>
              ...
              <div className="card mb-4">
                ...
                <div className="card-body">
                  <button type="button" className="btn btn-primary mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Primary</button>
                  <button type="button" className="btn btn-secondary mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Secondary</button>
                  <button type="button" className="btn btn-success mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Success</button>
                  <button type="button" className="btn btn-danger mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Danger</button>
                  <button type="button" className="btn btn-warning mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Warning</button>
                  <button type="button" className="btn btn-info mr-1"><span className="spinner-border spinner-border-sm mr-2" role="status" />Info</button>
                  <button type="button" className="btn btn-dark"><span className="spinner-border spinner-border-sm mr-2" role="status" />Dark</button>
                </div>
              </div>
              {/* /Progress Button */}
            </section>
