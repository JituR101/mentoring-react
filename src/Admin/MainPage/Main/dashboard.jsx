                    ...
                    <table className="table table-hover table-center mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={AVATAR_08} alt="User Image" /></a>
                              <a href="/admin/profile">James Amen</a>
                            </h2>
                          </td>
                          <td>Maths</td>
                          <td>$3200.00</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={AVATAR_07} alt="User Image" /></a>
                              <a href="/admin/profile">Jessica Fogarty</a>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={AVATAR_17} alt="User Image" /></a>
                              <a href="/admin/profile">Jose Anderson</a>
                            </h2>
                          </td>
                          <td>Algebra</td>
                          <td>$4000.00</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={AVATAR_06} alt="User Image" /></a>
                              <a href="/admin/profile">Sofia Brient</a>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={AVATAR_14} alt="User Image" /></a>
                              <a href="/admin/profile">Marvin Campbell</a>
                            </h2>
                          </td>
                          <td>Flow chart</td>
                          <td>$3500.00</td>
                    ...
                    <table className="table table-hover table-center mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={USER} alt="User Image" /></a>
                              <a href="/admin/profile">Jonathan Doe </a>
                            </h2>
                          </td>
                          <td>8286329170</td>
                          <td>20 Oct 2019</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={USER_1} alt="User Image" /></a>
                              <a href="/admin/profile">Julie Pennington </a>
                            </h2>
                          </td>
                          <td>2077299974</td>
                          <td>22 Oct 2019</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={USER_2} alt="User Image" /></a>
                              <a href="/admin/profile">Tyrone Roberts</a>
                            </h2>
                          </td>
                          <td>2607247769</td>
                          <td>21 Oct 2019</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={USER_3} alt="User Image" /></a>
                              <a href="/admin/profile">Allen Davis </a>
                            </h2>
                          </td>
                          <td>5043686874</td>
                          <td>21 Sep 2019</td>
                        ...
                        <tr>
                          <td>
                            <h2 className="table-avatar">
                              <a href="/admin/profile" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src={USER_4} alt="User Image" /></a>
                              <a href="/admin/profile">Patricia Manzi </a>
                            </h2>
                          </td>
                          <td>9548207887</td>
                          <td>18 Sep 2019</td>
