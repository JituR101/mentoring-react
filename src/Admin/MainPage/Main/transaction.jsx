...
class Clients extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isdeletemodal : false,
      data : [
         {id:1,invoicenumber:"#IN0001",mentee_id:"#01",image:USER,name:"Jonathan Doe",status:"Paid",total_amnt :"$100.00"},
         {id:2,invoicenumber:"#IN0002",mentee_id:"#02",image:USER_1,name:"Julie Pennington",status:"Paid",total_amnt :"$200.00"},
         {id:3,invoicenumber:"#IN0003",mentee_id:"#03",image:USER_2,name:"Tyrone Roberts",status:"Paid",total_amnt :"$250.00"},
         {id:4,invoicenumber:"#IN0004",mentee_id:"#04",image:USER_3,name:"Allen Davis",status:"Paid",total_amnt :"$150.00"},
         {id:5,invoicenumber:"#IN0005",mentee_id:"#05",image:USER_4,name:"Patricia Manzi",status:"Paid",total_amnt :"$350.00"},
         {id:6,invoicenumber:"#IN0006",mentee_id:"#06",image:USER_5,name:"Elsie Gilley",status:"Paid",total_amnt :"$300.00"},
         {id:7,invoicenumber:"#IN0007",mentee_id:"#07",image:USER_8,name:"Joan Gardner",status:"Paid",total_amnt :"$250.00"},
         {id:8,invoicenumber:"#IN0008",mentee_id:"#08",image:USER_9,name:"Daniel Griffing",status:"Paid",total_amnt :"$150.00"},
         {id:9,invoicenumber:"#IN0009",mentee_id:"#09",image:USER_11,name:"Walter Roberson",status:"Paid",total_amnt :"$120.00"},
         {id:10,invoicenumber:"#IN0010",mentee_id:"#10",image:USER_12,name:"Robert Rhodes",status:"Paid",total_amnt :"$100.00"}
      ],          
    };
  }
  editModalClose() {
      ...
      return ( 
        ...
        <div className="content container-fluid">
         ...
         <Modal className="modal-dialog-centered" isOpen={this.state.iseditmodal} toggle={() => this.editModalClose()}>
              <ModalHeader toggle={() => this.editModalClose()}>Edit Transactions</ModalHeader>
              <ModalBody>
                <form>
