            ...
            <div className="banner-wrapper m-auto text-center">
              ...
              <div className="search-box">
                <form action="/app/Pages/search">
                  ...
                  <button type="submit" className="btn btn-primary search-btn"><i><img src={Submit} alt="" /></i> <span>Search</span></button>
                </form>
              </div>
              {/* /Search */}
            </div>
            ...
            <OwlCarousel className="owl-theme">
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Donna Yancey</a></h3>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">James Amen</a></h3>
                    <div className="author-info">
                      <div className="author-name">
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Betty Hairston</a></h3>
                    <div className="author-info">
                      <div className="author-name">
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Jose Anderson</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        Digital Marketer
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Aaron Pietrzak</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        UNIX,Calculus,Trigonometry
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Brian Martinez</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        ASP.NET,Computer Gaming
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Misty Lundy</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        Computer Programming
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Vern Campbell</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        Digital Marketer
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Jessica Fogarty</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        UNIX,Calculus,Trigonometry
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Evelyn Stafford</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        ASP.NET,Computer Gaming
                      </div>
              ...
              <div className="course-box">
                <div className="product">
                  ...
                  <div className="product-content">
                    <h3 className="title"><a href="/app/Mentee/mentor-profile">Christopher Carroll</a></h3>
                    <div className="author-info">
                      <div className="author-name">
                        Computer Programming
                      </div>
              ...
              <div className="row">
                <div className="col-12 col-md-4 col-lg-3">
                  <div className="large-col">
                    <a href="/app/Pages/search" className="large-col-image">
        ...
        <section className="section section-blogs">
          <div className="container">
                    ...
                    <ul className="entry-meta meta-item">
                      <li>
                        <div className="post-author">
                          <a href="/app/Blog/blog-details"><span>Tyrone Roberts</span></a>
                        </div>
                      </li>
                      <li><i className="far fa-clock" /> 4 Dec 2019</li>
                    </ul>
                    <h3 className="blog-title"><a href="/app/Blog/blog-details">What is Lorem Ipsum? Lorem Ipsum is simply</a></h3>
                ...
                <div className="blog grid-blog">
                  ...
                  <div className="blog-content">
                    <ul className="entry-meta meta-item">
                      <li>
                        <div className="post-author">
                          <a href="/app/Blog/blog-details"><span>Brittany Garcia</span></a>
                        </div>
                      </li>
                      <li><i className="far fa-clock" /> 3 Dec 2019</li>
                    </ul>
                    <h3 className="blog-title"><a href="/app/Blog/blog-details">Contrary to popular belief, Lorem Ipsum is</a></h3>
                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                  </div>
                </div>
                {/* /Blog Post */}
                ...
                <div className="blog grid-blog">
                  ...
                  <div className="blog-content">
                    <ul className="entry-meta meta-item">
                      <li>
                        <div className="post-author">
                          <a href="/app/Blog/blog-details"><span>Allen Davis</span></a>
                        </div>
                      </li>
                      <li><i className="far fa-clock" /> 3 Dec 2019</li>
                    </ul>
                    <h3 className="blog-title"><a href="/app/Blog/blog-details">The standard chunk of Lorem Ipsum used</a></h3>
                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                  </div>
                </div>
                {/* /Blog Post */}
                ...
                <div className="blog grid-blog">
                  ...
                  <div className="blog-content">
                    <ul className="entry-meta meta-item">
                      <li>
                        <div className="post-author">
                          <a href="/app/Blog/blog-details"><span>William Lawrence</span></a>
                        </div>
                      </li>
                      <li><i className="far fa-clock" /> 2 Dec 2019</li>
                    </ul>
                    <h3 className="blog-title"><a href="/app/Blog/blog-details">The standard Lorem Ipsum passage, used</a></h3>
                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                  </div>
                </div>
                {/* /Blog Post */}
            ...
            <div className="view-all text-center"> 
              <a href="/app/Blog/blog-list" className="btn btn-primary">View All</a>
            </div>
          </div>
        </section>
        {/* /Blog Section */}	
