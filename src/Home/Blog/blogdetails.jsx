                        ...
                        <ul>
                          <li>
                            <div className="post-author">
                              <a href="/app/Mentee/mentor-profile"><img src={USER} alt="Post Author" /> <span>Marvin Downey</span></a>
                            </div>
                          </li>
                      ...
                      <div className="about-author">
                        <div className="about-author-img">
                          <div className="author-img-wrap">
                            <a href="/app/Mentee/mentor-profile"><img className="img-fluid rounded-circle" alt="" src={USER_1} /></a>
                          </div>
                        </div>
                        <div className="author-details">
                          <a href="/app/Mentee/mentor-profile" className="blog-author-name">Darren Elder</a>
                  ...
                  <div className="card-body">
                    <ul className="latest-posts">
                      ...
                      <li>
                        ...
                        <div className="post-info">
                          <h4>
                            <a href="/app/Blog/blog-details">to generate Lorem Ipsum which looks reasonable.</a>
                          </h4>
                          <p>1 Dec 2019</p>
                        </div>
                      </li>
