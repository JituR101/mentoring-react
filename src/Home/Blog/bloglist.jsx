            ...
            <div className="row">
              <div className="col-lg-8 col-md-12">
                ...
                <div className="blog">
                  ...
                  <h3 className="blog-title"><a href="/app/Blog/blog-details">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</a></h3>
                  <div className="blog-info clearfix">
                    <div className="post-left">
                      <ul>
                        <li>
                          <div className="post-author">
                            <a href="/app/Mentee/mentor-profile"><img src={USER} alt="Post Author" /> <span>Ruby Perrin</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog-content">
                    ...
                    <a href="/app/Blog/blog-details" className="read-more">Read More</a>
                  </div>
                </div>
                {/* /Blog Post */}
                {/* Blog Post */}
                <div className="blog">
                  <div className="blog-image">
                    <a href="/app/Blog/blog-details"><img className="img-fluid" src={BLOG_02} alt="" /></a>
                  </div>
                  ...
                  <div className="blog-info clearfix">
                    <div className="post-left">
                      <ul>
                        <li>
                          <div className="post-author">
                            <a href="/app/Mentee/mentor-profile"><img src={USER_1} alt="Post Author" /> <span>Darren Elder</span></a>
                          </div>
                        </li>
                ...
                <div className="blog">
                  ...
                  <h3 className="blog-title"><a href="/app/Blog/blog-details">The standard Lorem Ipsum passage, used since the</a></h3>
                  <div className="blog-info clearfix">
                    <div className="post-left">
                      <ul>
                        <li>
                          <div className="post-author">
                            <a href="/app/Mentee/mentor-profile"><img src={USER_2} alt="Post Author" /> <span>Deborah Angel</span></a>
                          </div>
                        </li>
                        <li><i className="far fa-clock" />3 Dec 2019</li>
                ...
                <div className="blog">
                  ...
                  <h3 className="blog-title"><a href="/app/Blog/blog-details">Section 1.10.32 of "de Finibus Bonorum et Malorum</a></h3>
                  <div className="blog-info clearfix">
                    <div className="post-left">
                      <ul>
                        <li>
                          <div className="post-author">
                            <a href="/app/Mentee/mentor-profile"><img src={USER_3} alt="Post Author" /> <span>Sofia Brient</span></a>
                          </div>
                        </li>
