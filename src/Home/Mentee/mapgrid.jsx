...
const data = [{
  id:1,
	...
	lng:150.6517938,
	"icons":"default",
	"profile_link":"/app/Mentee/mentor-profile",
	"total_review":"17",
	"image":USER
  },
   {
              ...
              <div className="row align-items-center mb-4">
                ...
                <div className="col-md-6 col-auto">
                  <div className="view-icons ">
                    <a href="/app/Mentee/map-grid" className="grid-view active"><i className="fas fa-th-large" /></a>
                    <a href="/app/Mentee/map-list" className="list-view"><i className="fas fa-bars" /></a>
                  </div>
              ...
              <div className="row">
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Ruby Perrin</a> 
                      ...
                      <div className="row row-sm">
                        <div className="col-6">
                          <a href="/app/Mentee/mentor-profile" className="btn view-btn">View Profile</a>
                        </div>
                        <div className="col-6">
                          <a href="/app/Mentee/booking" className="btn book-btn">Book Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Darren Elder</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                      <p className="speciality">Digital Marketer</p>
                      <div className="rating">
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Deborah Angel</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Sofia Brient</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Marvin Campbell</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Katharine Berthold</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                      <p className="speciality">UNIX,Calculus,Trigonometry</p>
                      <div className="rating">
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Linda Tobin</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Paul Richard</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">John Gibbs</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                      <p className="speciality">Digital Marketer</p>
                      <div className="rating">
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Olga Barlow</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                      <p className="speciality">Digital Marketer</p>
                      <div className="rating">
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Julia Washington</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                ...
                <div className="col-sm-6 col-md-4 col-xl-6">
                  <div className="profile-widget">
                    ...
                    <div className="pro-content">
                      <h3 className="title">
                        <a href="/app/Mentee/mentor-profile">Shaun Aponte</a> 
                        <i className="fas fa-check-circle verified" />
                      </h3>
                      <p className="speciality">UNIX,Calculus,Trigonometry</p>
                      <div className="rating">
