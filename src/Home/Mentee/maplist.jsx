              ...
              <div className="row align-items-center mb-4">
                ...
                <div className="col-md-6 col-auto">
                  <div className="view-icons">
                    <a href="/app/Mentee/map-grid" className="grid-view"><i className="fas fa-th-large" /></a>
                    <a href="/app/Mentee/map-list" className="list-view active"><i className="fas fa-bars" /></a>
                  </div>
                  ...
                  <div className="mentor-widget">
                    <div className="user-info-left">
                      ...
                      <div className="user-info-cont">
                        <h4 className="usr-name"><a href="/app/Mentee/mentor-profile">Ruby Perrin</a></h4>
                ...
                <div className="card-body">
                  <div className="mentor-widget">
                    <div className="user-info-left">
                      ...
                      <div className="user-info-cont">
                        <h4 className="usr-name"><a href="/app/Mentee/mentor-profile">Darren Elder</a></h4>
                ...
                <div className="card-body">
                  <div className="mentor-widget">
                    <div className="user-info-left">
                      ...
                      <div className="user-info-cont">
                        <h4 className="usr-name"><a href="/app/Mentee/mentor-profile">Deborah Angel</a></h4>
                ...
                <div className="card-body">
                  <div className="mentor-widget">
                    <div className="user-info-left">
                      ...
                      <div className="user-info-cont">
                        <h4 className="usr-name"><a href="/app/Mentee/mentor-profile">Sofia Brient</a></h4>
                ...
                <div className="card-body">
                  <div className="mentor-widget">
                    <div className="user-info-left">
                      ...
                      <div className="user-info-cont">
                        <h4 className="usr-name"><a href="/app/Mentee/mentor-profile">Katharine Berthold</a></h4>
                        <p className="mentor-type">UNIX, Calculus, Trigonometry</p>
                        <div className="rating">
                          <i className="fas fa-star filled" />
                          <i className="fas fa-star filled" />
