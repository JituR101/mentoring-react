            ...
            <div className="row">
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <div className="booking-user-info">
                      <a href="/app/Mentee/mentor-profile" className="booking-user-img">
                        <img src={USER_2} alt="User Image" />
                      </a>
                      <div className="booking-info">
                        <h4><a href="/app/Mentee/mentor-profile">Tyrone Roberts</a></h4>
                ...
                <div className="submit-section proceed-btn text-right">
                  <a href="/app/Mentee/checkout" className="btn btn-primary submit-btn">Proceed to Pay</a>
                </div>
                {/* /Submit Section */}
              </div>
            </div>
